...
do 
    ...
    do
        ...
        foldername="mcs${i}_ms${j}_3d"
        python generate_baseline_kitti_bounding_boxes.py kitti_detections/ ~/KITTI/object/training/ kitti_labels_experiments/hdbscan_2/$foldername -m hdbscan -mcs $i -ms $j -d 3
