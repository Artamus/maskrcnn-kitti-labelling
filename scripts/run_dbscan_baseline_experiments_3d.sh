...
do 
    ...
    do
        ...
        foldername="minsamp${i}_eps${j}_3d"
        python generate_baseline_kitti_bounding_boxes.py kitti_detections/ ~/KITTI/object/training/ kitti_labels_experiments/dbscan/$foldername -m dbscan -ms $i -e $j -d 3
