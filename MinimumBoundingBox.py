# Code from https://bitbucket.org/william_rusnack/minimumboundingbox/src/master/MinimumBoundingBox.py
# This file is reimplemented because installing does not work on tested Python and pip versions
